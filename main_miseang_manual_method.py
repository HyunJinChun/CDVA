...
def get_args_parser():
    ...
    parser.add_argument('--size', action='store_true') # 인물 크기
...
def main(args):
    ...
    if args.dataset_file == 'YoutubeVIS' or args.dataset_file == 'jointcoco' or args.dataset_file == 'Seq_coco' or args.dataset_file == 'Miseang':  ##
