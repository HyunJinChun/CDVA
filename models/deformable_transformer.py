...
class DeformableTransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, tgt_box, query_pos, reference_points, src, src_spatial_shapes, level_start_index, src_padding_mask=None):
        ...
        # cross attention done

        # ffn box
        tgt_box = self.forward_ffn_box(tgt_box)

        ## 논문 식(3) : the instance query aggregates the temporal features by a weighted sum of all the box queries,
        #              where the weights are end to end learned upon the box embedding
