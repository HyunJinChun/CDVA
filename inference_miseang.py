...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model_path', type=str, default='./220906_r101_miseang/VDA_None/checkpoint0014.pth',
    ...
    parser.add_argument('--save_path', default='../vis_test/hyeon/220906_r101_miseang/VDA_None/')
