...
def convert_annotations(annotations_list, start_instance_id, video_id, height, width, length, id_list):
    ...
    for anno in annotations_list:
        if anno["category_id"] not in [1, 2, 3, 4, 5, 6, 7]:
            continue
        ...
        track_dict[track_id][image_id] = anno
        track_dict[track_id][image_id]['category_id'] = 1
...
if __name__ == '__main__':
    ...
    vis_root = '../miseang_vis_data/vis_format_person/train/json'
    name = 'train.json'

    '''
    coco_root = '../miseang_vis_data/coco_format/validation/json'
    vis_root = '../miseang_vis_data/vis_format_person/validation/json'
