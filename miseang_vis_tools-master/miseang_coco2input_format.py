...
if __name__ == '__main__':
    coco_root = './miseang_add/coco_format/json'
    vis_root = './miseang_add/vis_format/json'
    name = 'instances_val_sub_add.json'

    '''
    coco_root = '../miseang_vis_data/coco_format/validation/json'
    vis_root = '../miseang_vis_data/vis_format/validation/json'
    name = 'validation.json'
    '''
    '''
    coco_root = '../miseang_vis_data/coco_format/test/json'
    vis_root = '../miseang_vis_data/vis_format/test/json'
    name = 'test.json'
    '''
