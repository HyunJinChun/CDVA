...
def apply_copy_paste(image_list, target, pasted_image_list, pasted_target, now_frames, target_key):
    ...
    # Paste 대상이 되는 객체 선택
    choice_target_list_dict = select_pasted_instance(pasted_target_list_dict, target_key, now_frames)
...
def select_pasted_instance(pasted_target_list_dict, target_key, now_frames):
    '''
    ...
    random_choice = [i for i in range(instance_cnt)] ## all categories
