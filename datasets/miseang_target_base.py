...
def make_copy_paste_transforms(size, position, GD, PD, all_frames):
    ...
    check = T.Check()
    hsv_transforms = transforms_copy_paste_using_getitem.PhotometricDistort()
    cp_transforms = transforms_copy_paste_using_getitem.CopyAndPaste()
    cp_compose = transforms_copy_paste_using_getitem.CopyPasteCompose(flip_transforms, resize_transforms, check, hsv_transforms,
...
def build(image_set, args):
    ...
    if args.dataset_file == 'Miseang':
        ...
        print('use Miseang dataset - miseang_target_base.py')
