...
import time
import numpy as np
from datasets import transforms_ObjectMix
...
def make_copy_paste_transforms():
    ...
    resize_transforms = transforms_ObjectMix.RandomResize(max_size=768)
    check = T.Check()
    cp_transforms = transforms_ObjectMix.CopyAndPaste()
    cp_compose = transforms_ObjectMix.CopyPasteCompose(flip_transforms, resize_transforms, check, cp_transforms,
...
def build(image_set, args):
    ...
    if args.dataset_file == 'Miseang':
        ...
        print('use Miseang dataset - miseang_ObjectMix.py')
